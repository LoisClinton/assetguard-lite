...
import {
  ...
  getJobs,
  seedJobs,
} from "../repositories/jobsRepository.web";

const JOBS_KEY = "assetguard_jobs";

describe("Web: Seeding Starter Jobs", () => {
  beforeEach(() => {
    localStorage.clear();
  });
  ...
  describe("seedJobs/addJobs", () => {
    it("should seed starter jobs when localStorage is empty", async () => {
      await seedJobs();
    ...
    it("should store jobs in localStorage under correct key", async () => {
      await seedJobs();
